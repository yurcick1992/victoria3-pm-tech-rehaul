...
const SPEC = {
  ...
  steel:       { eras:[0,2,3,4], years:[1745,1856,1885,1912], invent:[ {era:5, year:1932, slug:'strip_mill', name:'Continuous Strip Mill Steelworks', pm:'Continuous Wide Strip Mill'} ],
                 note:'⚠ THE ERA-1 GAP IS DELIBERATE, and the reason is the CALENDAR, not demand: vanilla\'s steel ladder runs 1745 blister -> 1856 Bessemer, an 111-year hole, and era 1\'s band is 1790-1850. Nothing in vanilla\'s steel progression lands inside it, because the 1790-1850 advances were in IRON (puddling, hot blast 1828), which vanilla models on the iron and tooling side. ⚠⚠ THE OLD SECOND REASON IS VOID: this note used to say "era-1 steel has no buyer of any kind (§10.32)", which was true when measured on 2026-08-05 and is NOT true now — the date gate and two re-bandings put motor e1, shipyard_steam e1 and arms e1 in era 1, all three eat steel, and the shipped 1836 scenario reads buy 112 against sell 78 with the price at 100%. Vanilla agrees there is a market: a melted 1838 gamestate consumes 1387 units/wk, 90.5% of it in tooling workshops (FINDINGS F54). ERA_PRUNE still excludes the blister mill at era 0, where there is genuinely no consumer, and dropping it outright is still on the long-term todo. The invented bloomery tier is gone; blister steel keeps the VANILLA key in slot 0, which is what the 1836 map’s six steel mills convert onto. Three re-dates, all defensible and all forced by one rung per era: open hearth 1868 -> 1885 (Siemens-Martin existed from 1865 but the BASIC process, Thomas 1879, is what made it dominant), electric arc 1903 -> 1912 (Heroult 1900, first plants 1903-06, real tonnage in the 1910s), continuous wide strip 1926 -> 1932 (ARMCO Butler 1926, but the strip-mill building wave is the 1930s).' },
