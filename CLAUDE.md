...
config/mod_config.canon-flat-in12-a16.json ⭐ TEST ARM 1 OF THE NEXT SESSION (user-ruled 2026-09-13; HANDOVER, schedule a16_vs_a22in12_n2x2.json):
                        ...
                        make_ab_config (`_ab.command`); dry-run build clean. Un-ignored with its twin. ⭐ LAUNCHED 2026-09-13 14:36 as arm 1 of
                        session 20260913_143610_a16-vs-a22in12-n2x2 (runs 1 and 3). Run 1 read (one seed): world GDP 0.57× the vanilla n=16 median
                        at 1935, productive workers per capita 0.67×, pools 0.09 of GDP all century, rung 0 ALIVE (56% staffed; consumer rungs
                        65–88%), below-best 39.2%, the tiered goods 1.0–1.3× vanilla's British prices — the step is too weak (two rungs behind
                        hold 0.30 of the frontier's VA per worker at base prices, above F97's 0.2 line); the batch's verdict and FINDINGS follow
config/mod_config.canon-je24-a22-in12.json ⭐ TEST ARM 2 (the control that isolates the death lever from cheap capital): canon-je24-a22 (phase 2) plus
                        ...
                        ⭐ LAUNCHED 2026-09-13 as arm 2 of session 20260913_143610 (runs 2 and 4)
config/mod_config.canon-flat-in12-a19.json ⭐ THE FOLLOW-UP CANDIDATE (generated 2026-09-13 17:24 under the user's pre-authorisation of one more 2–3-run
                        ...
                        inside). Launch decided after the 2+1 tests. Un-ignored with its twin
