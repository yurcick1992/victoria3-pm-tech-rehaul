...
config/mod_config.canon4v-hai3.json ⚗ THE RULED SET ON THE CANON (§10.75, user-ruled 2026-09-05): canon4v + ai_value 1000×3^era on
                        ...
                        Schedule canon4v_hai3_n2.json (n=2). ⭐ MEASURED 2026-09-05 (F106, session 20260905_174831, n=2): Britain's
...
config/mod_config.json      ⭐⭐ THE CANON = canon4v SINCE 2026-09-05 (four rungs on vanilla's own methods, the A/B book, the
                        academy on the regular ladder) — a verbatim copy of config/mod_config.canon4v.json, regenerated by the
                        vanilla-only pipeline (make_tier4_config → make_tier4_techs → make_ab_config --suffix canon4v) and
