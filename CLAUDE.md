...
⭐⭐⭐ **THE CANON WAS REGENERATED UNDER THE ERA RULE ON 2026-09-13** (the section above): `config/mod_config.json` = `canon4v-hai3`
regenerated by the era-keyed generator — automotive, munition, synthetics and electrics re-priced at their eras, electrics moved
e1 → e2, everything else byte-identical. The book F106/F107 measured is commit `880f098`'s copy.
...
config/tech_tree_options.json ⭐⭐ SINCE 2026-09-05 the canon4v tree (make_tier4_techs.mjs's output, copied from its canon4v
                        twin) — vanilla's technologies at vanilla's eras plus the four minted ones; the three six-rung candidate
