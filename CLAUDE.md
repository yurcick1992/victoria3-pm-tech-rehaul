...
config/mod_config.canon4-art.json ⚗ THE ART-ACADEMY STRESS TEST (§10.70, 2026-09-04): canon4-je with the art academy alone at A=3
                        (fine art 5/15/45/135, cost 400/1,200/3,600/10,800, ai_value 1000×3^era), divisor pinned at 0.000125;
...
tools/                  dev tooling — NOT shipped in the mod
  ...
  make_ab_config.mjs    ⚗⚗ THE A/B LADDER (user-ruled 2026-09-02, BALANCE_FRAMEWORK §10.68 — two arms
                        ...
                        ONE industry its own output ratio — output × Ai^k, cost × Ai^k, ai_value 1000 × Ai^era — the art-academy
                        stress test (§10.70: `art_academy:3`, fine art 5/15/45/135); ⚠ PIN `--divisor` with it (the auto value
                        follows the dearest rung and would re-score every building), the canon's is 0.000125 — ab3 = ab2 + glass,tooling:3
