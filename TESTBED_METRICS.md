...
| `active_pms` | none | **REPLACEABLE — confirmed at field level** (2026-08-16, calib2's 1840 melt): every one of the 7,738 building records carries `production_methods={ "pm_x" … }`, the full active list incl. secondaries (e.g. gov admin: religious_bureaucrats + professional_bureaucrats + vertical_filing_cabinets) |
